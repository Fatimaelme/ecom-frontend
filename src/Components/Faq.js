...
const Faq = () => {
  return (
    <section className="flex items-center bg-fuchsia-50 py-11 font-poppins dark:bg-gray-800">
  <div className="max-w-6xl px-4 mx-auto">
    <div className="max-w-4xl mx-auto text-center">
      <span className="inline-block px-2 py-px mb-4 text-xs font-medium leading-5 text-fuchsia-500 bg-fuchsia-100 rounded-full shadow-sm dark:text-gray-400 dark:bg-gray-700">
        FAQ
      </span>
      ...
      une collection accessible des questions les plus courantes sur le produit/service/entreprise et leurs réponses
      </p>
    </div>
      ...
      <div className="w-full px-4 mb-16 md:w-1/2 lg:w-1/3">
        <div className="relative h-full px-8 pt-16 pb-8 transition duration-200 rounded-md shadow-md bg-gray-50 dark:bg-gray-900 ">
          <div className="absolute top-0 inline-flex items-center justify-center w-16 h-16 transition duration-200 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-full dark:bg-gray-800 left-1/2">
            <div className="inline-flex items-center justify-center w-12 h-12 text-white bg-fuchsia-500 rounded-full">
              <svg
