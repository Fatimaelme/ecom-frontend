...
<section className="flex flex-col  lg:justify-end font-poppins ">
  <div className="w-full bg-fuchsia-50 border-t dark:border-gray-900 py-4 dark:bg-gray-900">
    <div className="max-w-6xl mx-auto">
      <div className=" max-w-6xl px-4 py-2 mx-auto lg:py-0">
        <div className="flex flex-wrap justify-between py-4 -mx-3">
          <div className="w-full px-4 mb-7 md:w-1/2 lg:w-4/12 lg:mb-0">
            <a
              href="#"
              className="flex self-start pb-2 text-lg font-bold dark:text-gray-400"
            >
              About Company
            </a>
            <div className="w-16 mb-4 border-b-2 border-fuchsia-500 dark:border-gray-600" />
            <p className="text-base font-normal leading-6 lg:w-64 dark:text-gray-400">
              Nous vendons les produits cosmétiques 100% naturel de notre royaume aussi des produits importés de l'étranger{" "}
            </p>
          </div>
          <div className="w-full px-4 mb-2 lg:mb-0 md:w-1/3 lg:w-4/12 ">
            <h2 className="pb-2 text-lg flex self-start font-bold text-gray-800 dark:text-gray-400 ">
              Contact Info
            </h2>
            <div className="w-16 mb-4 border-b-2 border-purple-500 dark:border-gray-600" />
      ...
      <div className="flex flex-wrap items-center justify-between px-4 mb-4">
        ...
        <div className="flex flex-wrap">
          ...
          <div className="w-full py-1 lg:w-auto lg:py-0">
            <a
              href="#"
              className="inline-block w-full px-5 py-4 font-medium leading-4 text-center text-gray-100 bg-fuchsia-500 hover:bg-slate-100 hover:text-slate-950 rounded-md dark:bg-gray-700 dark:text-gray-400 dark:hover:bg-gray-800"
            >
              Subscribe
            </a>
          </div>
  ...
  <div className="px-4 py-6 bg-fuchsia-300 dark:bg-gray-800 dark:text-gray-400">
    <div className="flex flex-wrap items-center justify-between max-w-6xl gap-4 mx-auto">
      <div className=" text-white font-black"> © Copyright 2022 . All Rights Reserved</div>
      <div className="flex items-center gap-3">
        <a
          href="#"
          className="mr-4 text-white dark:text-gray-400 hover:text-blue-600"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width={16}
        ...
        <a
          href="#"
          className="mr-4 text-white dark:text-gray-400 hover:text-red-600"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width={16}
